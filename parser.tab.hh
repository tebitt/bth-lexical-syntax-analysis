  ...
  private:
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_ClassDeclaration = 46,                 // ClassDeclaration
        S_VarDeclaration = 47,                   // VarDeclaration
        S_MethodDeclaration = 48,                // MethodDeclaration
        S_Type = 49,                             // Type
        S_Statement = 50,                        // Statement
        S_Expression = 51,                       // Expression
        S_ClassDeclarationList = 52,             // ClassDeclarationList
        S_StatementList = 53,                    // StatementList
        S_VarDeclarationList = 54,               // VarDeclarationList
        S_MethodDeclarationList = 55,            // MethodDeclarationList
        S_TypeIdentList = 56,                    // TypeIdentList
        S_VarDeclarationOrStatementList = 57,    // VarDeclarationOrStatementList
        S_ExpressionList = 58,                   // ExpressionList
